...
Present and past members of ICES WGFAST Topic Group on Acoustic Metadata (TG-AcMeta) are acknowledged for facilitating metadata standards and developing of this convention document.
